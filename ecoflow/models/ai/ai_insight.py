...
class EcoflowAiInsight(models.Model):
    ...
    def _insight_missed_collections(self):
        ...
        if zscores and zscores[-1] >= 2.0 and series[-1] > 0:
            out.append({
                ...
                "confidence": 85,
                "action_xmlid": "ecoflow.action_service_order",
    ...
    def _insight_diversion_gap(self):
        ...
        if diversion + 0.5 < target:
            ...
            return [{
                ...
                "confidence": 82,
                "action_xmlid": "ecoflow.action_process_batch",
                "icon": "fa-recycle",
            }]
        return [{
    ...
    def _insight_permits(self):
        ...
        if expired:
            out.append({
                ...
                "confidence": 99,
                "action_xmlid": "ecoflow.action_permit",
                "icon": "fa-id-card",
            })
        if expiring:
            out.append({
    ...
    def _insight_smart_collection(self):
        ...
        return [{
            ...
            "confidence": 78,
            "action_xmlid": "ecoflow.action_bin_prediction",
            "icon": "fa-trash",
        }]
    ...
    def _insight_demand_trend(self):
        ...
        return [{
            ...
            "confidence": 75,
            "action_xmlid": "ecoflow.action_ai_forecast",
            "icon": "fa-line-chart",
        }]
